...
<head>
  ...
  <title>Priyawart Rangila - Registration</title>
      ...
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
        <div class="card border border-light-subtle rounded-3 shadow-sm">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <h4 class="text-center">Enter Your Details To Register</h4>
            <form method="POST" action="{{ route('register.do') }}">
              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="Enter Email ID Here" required>
